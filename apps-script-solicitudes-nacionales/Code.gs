 ...
 *
 * Lee la hoja ModificacionBancaria de la planilla ProvChileSantiago y
...
function doGet() {
  return HtmlService.createHtmlOutputFromFile('Index')
    .setTitle('Solicitudes Bancarias - Nacionales')
...
function abrirPanel() {
  var html = HtmlService.createHtmlOutputFromFile('Index')
    .setWidth(1100)
    .setHeight(760);
  SpreadsheetApp.getUi().showModalDialog(html, 'Solicitudes Bancarias - Nacionales');
}
...
/**
 * Devuelve las solicitudes registradas en ModificacionBancaria, más
