...
let hoja = ss.insertSheet('Casos', [
  ...
  ['1224', '26/12/2023', '23/1/2024', 'Matias Sumonte', '', '', '', 'EAST COAST MILLWORK', 'Cerrado'],
  ['1999', '26/12/2023', '', 'Matias Sumonte', '', '', '', 'Caso sin cerrar', 'Abierto']
]);
...
ok(fila(hoja, 2)[4] === 2023, 'E2 = año de la fecha de cierre (2023)');
ok(esHoy(fila(hoja, 2)[5]), 'F2 = la fecha de hoy');
ok(fila(hoja, 2)[6] === diasHasta(26, 12, 2023), 'G2 = días entre el cierre y hoy');
ok(fila(hoja, 3)[4] === 2024 && fila(hoja, 3)[6] === diasHasta(23, 1, 2024), 'lee fechas de un dígito (23/1/2024)');
ok(fila(hoja, 4)[4] === '' && fila(hoja, 4)[6] === '' && esHoy(fila(hoja, 4)[5]),
  'sin fecha de cierre: año y días quedan vacíos, hoy igual se escribe');
...
ok(fila(hoja, 3)[4] === 2024 && fila(hoja, 3)[6] === diasHasta(23, 1, 2024), 'llena la fila 3');
...
// ---------------------------------------------------------------------------
seccion('Formatos de fecha que puede tener la columna C');
...
ok(diasEntre_(aFecha_('01/03/2024'), aFecha_('01/01/2024')) === -60, 'cierre a futuro: negativo');
