...
hoy = Date
inicio = DateSerial(Year(hoy), Month(hoy), 1)
fin = DateSerial(Year(hoy), Month(hoy)+1, 0)
...
WaitSeconds 0.7
SetText "wnd[0]/usr/ctxtEKKO-LIFNR", "6000089519"
...
SetText "wnd[0]/usr/txtEKKO-KTWRT", "51.994,00"
SetText "wnd[0]/usr/txtRM06E-KTWRT", "51.994,00"
SetText "wnd[0]/usr/ctxtEKKO-KTWRT", "51.994,00"
SetText "wnd[0]/usr/ctxtRM06E-KTWRT", "51.994,00"
SetText "wnd[0]/usr/ctxtEKKO-WAERS", "USD"
SetText "wnd[0]/usr/ctxtRM06E-WAERS", "USD"
...
Call ClosePopups()
WaitSeconds 0.5
' Segundo Enter: confirma la advertencia de fecha de contrato pasada
session.findById("wnd[0]").sendVKey 0
Call ClosePopups()
WaitSeconds 1
SetText "wnd[0]/usr/ctxtRM06E-KDATB", d1
...
items = Array( _
Array("TROZO16", "35", "M3", "54"), _
Array("TROZO18", "53", "M3", "54"), _
Array("TROZO20", "59", "M3", "54"), _
Array("TROZO22", "51", "M3", "54"), _
Array("TROZO24", "46", "M3", "55"), _
Array("TROZO26", "36", "M3", "55"), _
Array("TROZO28", "30", "M3", "55"), _
Array("TROZO30", "27", "M3", "56"), _
Array("TROZO32", "21", "M3", "56"), _
Array("TROZO34", "20", "M3", "56"), _
Array("TROZO36", "18", "M3", "56"), _
Array("TROZO38", "17", "M3", "56"), _
Array("TROZO40", "17", "M3", "56"), _
Array("TROZO42", "18", "M3", "56"), _
Array("TROZO44", "17", "M3", "56"), _
Array("TROZO16", "35", "M3", "56"), _
Array("TROZO18", "53", "M3", "56"), _
Array("TROZO20", "59", "M3", "56"), _
Array("TROZO22", "51", "M3", "56"), _
Array("TROZO24", "46", "M3", "57"), _
Array("TROZO26", "36", "M3", "57"), _
Array("TROZO28", "30", "M3", "57"), _
Array("TROZO30", "27", "M3", "58"), _
Array("TROZO32", "21", "M3", "58"), _
Array("TROZO34", "20", "M3", "58"), _
Array("TROZO36", "18", "M3", "58"), _
Array("TROZO38", "17", "M3", "58"), _
Array("TROZO40", "17", "M3", "58"), _
Array("TROZO42", "18", "M3", "58"), _
Array("TROZO44", "17", "M3", "58") _
)

session.findById("wnd[0]").sendVKey 0
Call ClosePopups()
Call WaitSeconds(0.5)
' Segundo Enter: confirma la advertencia de fecha de contrato pasada
session.findById("wnd[0]").sendVKey 0
Call ClosePopups()
Call WaitSeconds(1)
