...
contrato = Trim(InputBox("Pegue el numero del contrato marco (46xxxxxxxx) del proveedor:" & vbCrLf & vbCrLf & "HUGO BERNARDO ZENTENO ARIAS", "Contrato marco para el pedido 48"))
