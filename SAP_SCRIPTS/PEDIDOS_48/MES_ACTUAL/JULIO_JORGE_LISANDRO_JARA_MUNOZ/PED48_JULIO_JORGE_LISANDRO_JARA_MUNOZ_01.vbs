...
contrato = Trim(InputBox("Pegue el numero del contrato marco (46xxxxxxxx) del proveedor:" & vbCrLf & vbCrLf & "JULIO JORGE LISANDRO JARA MUNOZ", "Contrato marco para el pedido 48"))
