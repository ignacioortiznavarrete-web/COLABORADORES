...
contrato = Trim(InputBox("Pegue el numero del contrato marco (46xxxxxxxx) del proveedor:" & vbCrLf & vbCrLf & "RODRIGO CAMPOS FOREST SPA", "Contrato marco para el pedido 48"))
