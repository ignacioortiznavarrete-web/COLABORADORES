...
contrato = Trim(InputBox("Pegue el numero del contrato marco (46xxxxxxxx) del proveedor:" & vbCrLf & vbCrLf & "COMERCIAL FORESTAL NUBLE LTDA", "Contrato marco para el pedido 48"))
