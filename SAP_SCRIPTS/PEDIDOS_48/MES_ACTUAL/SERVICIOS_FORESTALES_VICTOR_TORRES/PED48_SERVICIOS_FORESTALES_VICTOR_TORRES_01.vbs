...
contrato = Trim(InputBox("Pegue el numero del contrato marco (46xxxxxxxx) del proveedor:" & vbCrLf & vbCrLf & "SERVICIOS FORESTALES VICTOR TORRES", "Contrato marco para el pedido 48"))
