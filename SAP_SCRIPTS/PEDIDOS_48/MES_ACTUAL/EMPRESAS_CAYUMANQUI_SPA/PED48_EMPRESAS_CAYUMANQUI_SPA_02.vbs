...
contrato = Trim(InputBox("Pegue el numero del contrato marco (46xxxxxxxx) del proveedor:" & vbCrLf & vbCrLf & "EMPRESAS CAYUMANQUI SPA", "Contrato marco para el pedido 48"))
