...
contrato = Trim(InputBox("Pegue el numero del contrato marco (46xxxxxxxx) del proveedor:" & vbCrLf & vbCrLf & "COMERCIAL QUILODRAN S A", "Contrato marco para el pedido 48"))
