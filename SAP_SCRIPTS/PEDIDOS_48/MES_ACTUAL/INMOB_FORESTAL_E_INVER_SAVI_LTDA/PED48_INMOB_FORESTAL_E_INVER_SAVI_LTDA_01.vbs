...
contrato = Trim(InputBox("Pegue el numero del contrato marco (46xxxxxxxx) del proveedor:" & vbCrLf & vbCrLf & "INMOB FORESTAL E INVER SAVI LTDA", "Contrato marco para el pedido 48"))
